...
export const editPizza = (editedpizza) => async (dispatch) => {
  try {
    ...
    console.log('Edit Pizza Error:', error.response.data); // Log the error for debugging
  }
};

export const deletePizza = (pizzaid) => async (dispatch) => {
  try {
    const response = await axios.post('/api/pizzas/deletepizza', { pizzaid }); // updated URL
